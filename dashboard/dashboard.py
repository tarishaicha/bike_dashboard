...
# Assuming 'dashboard' is a subdirectory in the current working directory
file_path = os.path.join('dashboard', 'merged_data.csv')
bike_share_df = pd.read_csv(file_path)
